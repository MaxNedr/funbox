...
window.onload = function () {
    ...
    const header_item1 = document.getElementById('header_item1');
    ...
    item1.addEventListener('click', function () {
        if (item1.hasAttribute('selected')) {
            ...
            weight1.classList.remove('bc-p_hover');
            weight1.classList.add('bc-b');
            header_item1.classList.remove('color_pink');
            header_item1.classList.add('color_666');
            header_item1.innerText = 'Сказочное заморское яство'
        } else {
            ...
            weight1.classList.add('bc-p');
            item1.classList.add('bc-p');
            header_item1.classList.remove('color_666');
            header_item1.classList.add('color_pink');
            header_item1.innerText = 'Котэ не одобряет?'
